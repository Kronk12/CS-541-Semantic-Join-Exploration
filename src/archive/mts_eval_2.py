...
def run_medical_search():
    ...
    configs = [
        ...
        {"proj": True,  "thresh": 0.10, "label": "0.10_projected"},
    ...
    for i, config in enumerate(configs, 1):
        ...
        for trial in range(1, trials_per_config + 1):
            print(f"--- Config {i}/{len(configs)} | Trial {trial}/{trials_per_config} | Config: {config['label']} | Thresh: {config['thresh']} | Proj: {proj_req} ---")
